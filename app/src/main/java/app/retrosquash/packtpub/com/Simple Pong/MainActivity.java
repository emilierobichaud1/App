package app.retrosquash.packtpub.com.realretrosquash;
...
public class MainActivity extends Activity {
    ...
    class SquashCourtView extends SurfaceView implements Runnable {
        ...
        public void updateCourt() {
            ...
            //has ball hit racket
            if(ballPosition.y + ballWidth >= (racketPosition.y -
                    racketHeight /2)) {
                int halfRacket = racketWidth / 2;
                if(ballPosition.x + ballWidth >
                        (racketPosition.x - halfRacket) &&
                        ballPosition.x - ballWidth < (racketPosition.x
                                + halfRacket)) {
                    soundPool.play(sample3, 1, 1,
                            0, 0, 1);
                    score++;
                    ballIsMovingUp=true;
                    ballIsMovingDown=false;

                    //decide how to rebound the ball
        ...
        public void drawCourt() {
            ...
            if(ourHolder.getSurface().isValid()) {
                ...
                paint.setColor(Color.argb(255,255,
                        255,255));
